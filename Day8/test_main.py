...
class TestInitialise(unittest.TestCase):
    ...
    def test_initialise_returns_matrix_of_equal_sizes(self):
        ...
        test_matrix_3 = []
        test_matrix_4 = []
        main.initialise_other_matrices(self.small_matrix, test_matrix_1, test_matrix_2, test_matrix_3, test_matrix_4)
        ...
        main.initialise_other_matrices(self.large_matrix, test_matrix_1, test_matrix_2, test_matrix_3, test_matrix_4)
...
class TestTranspose(unittest.TestCase):
    ...
    def test_transpose_matrix(self):
        ...
        test_matrix_3 = []
        viewing_distances = []
        main.initialise_other_matrices(self.small_matrix, transposed_small_matrix, transposed_big_matrix, test_matrix_3, viewing_distances)
        ...
        transposed_big_matrix = []
        test_matrix_3 = []
        main.initialise_other_matrices(self.large_matrix, transposed_small_matrix, transposed_big_matrix, test_matrix_3, viewing_distances)
...
class TestViewingDistances(unittest.TestCase):
    ...
    def test_reversed_list_returns_expected_values(self):
        test_matrix = [[1, 2, 3, 4, 3, 2, 1, 1] for i in range(8)]
        expected = [1, 2, 3, 4, 1, 1, 1, 0]
        main.get_viewing_distances(test_matrix, self.viewing_distances, is_reversed=True)
        self.assertEqual(self.viewing_distances[1], expected)
