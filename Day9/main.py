...
def move_head(direction, head_position):
    if direction == "L":
        for key, value in head_position.items():
            head_position = {key - 1: value}
    elif direction == "R":
        for key, value in head_position.items():
            head_position = {key + 1: value}
    elif direction == "U":
        for key, value in head_position.items():
            head_position = {key : value + 1}
    elif direction == "D":
        for key, value in head_position.items():
            head_position = {key : value - 1}
    else:
...
def move_tail(old_head_position, head_position, tail_position):
    for head_x, head_y in head_position.items():
        head_x = head_x
        head_y = head_y
    for tail_x, tail_y in tail_position.items():
        tail_x = tail_x
        tail_y = tail_y
