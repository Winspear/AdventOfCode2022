...
"""
    ...
    with open('Ropes.txt', 'r') as text:
        ...
        # There are this many tail positions:  6175
        ...
        for line in text.readlines():
            ...
            for i in range(int(movements)):
                for knot_index in range(len(positions)):
                    if knot_index == 0:
                        previous_head_position = positions[0]
                        positions[0] = move_head(direction, positions[0])
                    else:
                        positions[knot_index] = move_tail(positions[knot_index - 1], positions[knot_index])
...
def move_head(direction, head_position):
    if direction == "L":
        ...
        raise Exception(f"Direction not found: was {direction}")
    return head_position

def move_tail(head_position, tail_position):
    head_x = head_position.real
    head_y = head_position.imag
    tail_x = tail_position.real
    tail_y = tail_position.imag

    x_difference = head_x - tail_x
    y_difference = head_y - tail_y
